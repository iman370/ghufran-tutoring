...
function Proof() {
    return(
        <div id="proof-container">
            ...
            <div id="content2">
                <h2>Peer-reviewed studies only confirm what medical and engieering students have been using to graduate from their universities with First-Class degrees.</h2>
